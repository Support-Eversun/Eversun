...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      // Modern Primary: Cyan gradient with glassmorphism on hover
      primary:
      ...
      // Modern Secondary: Slate with glassmorphism
      secondary:
      ...
      // Modern Outline: Cyan border with glassmorphism
      outline:
